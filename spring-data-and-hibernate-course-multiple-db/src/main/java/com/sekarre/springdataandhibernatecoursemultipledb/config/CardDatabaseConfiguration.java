...
@EnableJpaRepositories(
        basePackages = "com.sekarre.springdataandhibernatecoursemultipledb.repositories.creditcard",
...
public class CardDatabaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean cardEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        ...
        LocalContainerEntityManagerFactoryBean efb = builder
    ...
    public PlatformTransactionManager cardTransactionManager(
            @Qualifier("cardEntityManagerFactory") LocalContainerEntityManagerFactoryBean emf) {

package com.sekarre.springdataandhibernatecoursemapping;
...
import com.sekarre.springdataandhibernatecoursemapping.repositories.OrderHeaderRepository;
...
public class DataLoadTest {
    ...
    @Test
    void testDBLock() {
        OrderHeader orderHeader = orderHeaderRepository.findById(23L).get();

        Address billTo = Address.builder().address("Bill me").build();
